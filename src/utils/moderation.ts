...
export async function moderateContent(text: string): Promise<{
    ...
    try {
        ...
        const scores = (
            result.category_scores ? Object.fromEntries(Object.entries(result.category_scores)) : {}
        ...
        const needsReview = flaggedCategories.some(cat => sensitiveCategories.includes(cat))
